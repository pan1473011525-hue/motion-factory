...
export const TransitionWipeClock: React.FC<TransitionWipeClockProps> = (props) => <AlphaSurface><ThemeProvider preset={props.stylePreset} accent={props.accentColor}><SafeArea><EntranceExit style={{position: "absolute", inset: 0, display: "grid", placeItems: "center"}}><GeneratedTitle title={props.title} /></EntranceExit></SafeArea></ThemeProvider></AlphaSurface>;
