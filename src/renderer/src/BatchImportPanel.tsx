...
export const BatchImportPanel: React.FC<{
  ...
  return <div className="batch-import-panel">
    <div className="batch-heading"><div><strong>批量预览</strong><span>{draft.fileName} · {draft.records.length} 行</span></div><button type="button" onClick={onClose}>关闭</button></div>
