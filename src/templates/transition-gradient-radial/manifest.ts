...
export const transitionGradientRadialManifest = defineTemplateManifest<TransitionGradientRadialProps>({
  ...
  tags: ["径向渐变遮罩"], description: "径向渐变溶解黑白转场遮罩，软边圆扩散。", schema: transition_gradient_radialSchema,
  defaultProps: {title: "径向渐变遮罩", accentColor: "#47A7FF", stylePreset: "editorial"},
  fields: [
  ...
  stylePresets: [{id: "editorial", name: "编辑部", patch: {stylePreset: "editorial"}}, {id: "minimal", name: "极简", patch: {stylePreset: "minimal"}}, {id: "vibrant", name: "鲜明", patch: {stylePreset: "vibrant"}}], migrations: [], preview: {accent: "#FFFFFF", label: "径向"},
});
