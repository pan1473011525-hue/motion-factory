...
export const transitionInkManifest = defineTemplateManifest<TransitionInkProps>({
  ...
  tags: ["墨水洇染遮罩"], description: "墨水洇染扩散的黑白转场遮罩，边缘带自然晕染。", schema: transition_inkSchema,
  defaultProps: {title: "墨水洇染遮罩", accentColor: "#47A7FF", stylePreset: "editorial"},
  fields: [
  ...
  stylePresets: [{id: "editorial", name: "编辑部", patch: {stylePreset: "editorial"}}, {id: "minimal", name: "极简", patch: {stylePreset: "minimal"}}, {id: "vibrant", name: "鲜明", patch: {stylePreset: "vibrant"}}], migrations: [], preview: {accent: "#FFFFFF", label: "墨染"},
});
