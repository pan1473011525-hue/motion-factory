...
export const photo_masonrySchema = z.object({
...
export type PhotoMasonryProps = z.infer<typeof photo_masonrySchema>;

export const photoMasonryManifest = defineTemplateManifest<PhotoMasonryProps>({
  id: "photo-masonry", compositionId: "PhotoMasonry", version: "1.0.0", name: "瀑布流", category: "media",
  tags: ["瀑布流", "多图", "小红书", "首页"], description: "多张图片按瀑布流错落排列，整墙缓滚并逐张浮起。", schema: photo_masonrySchema,
  defaultProps: {title: "", asset1: "", asset2: "", asset3: "", asset4: "", asset5: "", asset6: "", asset7: "", asset8: "", asset9: "", columns: 3, gap: 10, radius: 8, accentColor: "#47A7FF", stylePreset: "editorial"},
  fields: [
  ...
  migrations: [], preview: {accent: "#47A7FF", label: "☷ 瀑布"},
});
